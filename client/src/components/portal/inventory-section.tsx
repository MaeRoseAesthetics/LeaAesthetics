    ...
    <div className="p-4 lg:p-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-lea-charcoal-grey mt-1">
            Track stock levels and manage your supplies
          </p>
        </div>
      ...
      <Card className="bg-lea-platinum-white border-lea-silver-grey">
        <CardContent className="p-12 text-center text-lea-charcoal-grey">
          <i className="fas fa-boxes text-4xl mb-4 text-lea-elegant-silver"></i>
          <p className="text-lg font-medium mb-2">Inventory System</p>
          <p>Complete stock management and supply tracking interface</p>
        </CardContent>
      </Card>
    </div>
  );
